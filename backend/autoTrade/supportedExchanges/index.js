          ...
          transitions: {
              ...
              "UPDATE_UNSOLD": {
                    ...
                    notPartiallyMet: async function({orderStatus}) {
                        ...
                        let qty = context.confirmedBalance
              ...
              "RESULTS": {
                  results: function() {
                      postResults({
                        ...
                        totalMined: context.totalQty, profitReinvestment: reinvestmentRate, 
